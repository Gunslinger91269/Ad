...
function preload(){
    ...
    music=loadSound("Spookymusic.mp3")
}
function setup(){
...
function draw(){
  ...
  Engine.update(engine)
    ...
    if(frameCount%1200){
       ...
       if(boy1.x<0 || boy1.y>400){
         gameState = "end"
       }

       console.log(boy1.x+" "+boy1.y);
    ...
    if(gameState === "end"){
      ...
      stroke("red")
      fill("white")
      text("HAHA YOU LOST!!",windowWidth/2-300,windowHeight/2)
    }
}
...
function createBlock(){
    ...
    function keyPressed(){
      if(keyCode===32){
        ...
        Matter.Body.translate(guy.body,{x:10,y:-200})
      }
    }